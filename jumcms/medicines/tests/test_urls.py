...
class TestUrls(SimpleTestCase):
    ...
    def test_all_prescriptions_url_is_resolved(self):
        ...
        self.assertEqual(resolve(url).func, all_prescriptions)
    ...
    def test_search_prescriptions_url_is_resolved(self):
        ...
        self.assertEqual(resolve(url).func, search_prescriptions)
    ...
    def test_prescription_details_url_is_resolved(self):
        ...
        self.assertEqual(resolve(url).func, prescription_details)
    ...
    def test_dispense_medicines_url_is_resolved(self):
        ...
        self.assertEqual(resolve(url).func, dispense_medicines)
